...
function Rd() {
  const [e, n] = el.useState("#FFFFFF"),
    t = (r) => {
      n(r.target.value);
    };
  return we.jsxs("div", {
    className:
      "flex flex-col justify-around items-center border-2 border-black w-[20%] h-[36vh] rounded-md",
    children: [
      we.jsx("h1", {
        className:
          "text-xl font-bold border-b-2 pb-2 text-center border-black w-full",
        children: "My Color Picker",
      }),
      we.jsx("div", {
        className:
          "color-display w-full flex justify-center items-center border border-black p-4",
        style: { backgroundColor: e },
        children: we.jsxs("p", {
          className: "text-xl w-full border-black",
          children: ["Selected Color: ", e],
        }),
      }),
      we.jsx("label", { htmlFor: "", children: "Select a Color:" }),
      we.jsx("input", { type: "color", value: e, onChange: t }),
    ],
  });
}
function Od() {
  return we.jsx(we.Fragment, {
    children: we.jsx("div", {
      className: "main p-4 m-0",
      children: we.jsx(Rd, {}),
    }),
  });
}
Ql.createRoot(document.getElementById("root")).render(
  we.jsx(wc.StrictMode, { children: we.jsx(Od, {}) })
);
